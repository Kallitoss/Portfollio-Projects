...
--looking at total casses v total deaths
...
--looking at total casses vs total deaths in my country
...
--looking at total casses vs total deaths in all countrys whose names start on letter S
...
--Here I will show the continents with the highest death count per population
...
-- Showing the percentage of the population that received at least one COVID vaccine
...
--Using CTE to perform a calculation on partition by COLUMN that was created in the previous query
...
--- Using Temp table to perform a calculation on partition by COLUMN that was created in the previous query
